...
type SE struct {
	...
	PostIBBHash manifest.HashStructure

	IBBEntryPoint uint32 `json:"seIBBEntry"`

	DigestList manifest.HashStructure `json:"seDigestList"`
...
func (flags SEFlags) Reserved0() uint32 {
	return uint32(flags & 0xfffffff0)
}
